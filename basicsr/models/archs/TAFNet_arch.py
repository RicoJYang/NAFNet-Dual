...
class TAFNet(nn.Module):
    def __init__(self, width=32, middle_blk_num=12, enc_blk_nums=[2, 2, 4, 8], dec_blk_nums=[2, 2, 2, 2]):
        ...
        self.dnafnet = DNAFNet(width=width, middle_blk_num=middle_blk_num, enc_blk_nums=enc_blk_nums,
...
class TAFNetLocal(Local_Base, TAFNet):
    def __init__(self, *args, train_size=(1, 3, 256, 256), fast_imp=False, **kwargs):
        Local_Base.__init__(self)
        TAFNet.__init__(self, *args, **kwargs)
...
class RTAFNet(nn.Module):
    def __init__(self, width=32, middle_blk_num=12, enc_blk_nums=[2, 2, 4, 8], dec_blk_nums=[2, 2, 2, 2]):
        super().__init__()
        self.nafnet = NAFNet(width=64, middle_blk_num=12, enc_blk_nums=[2, 2, 4, 8], dec_blk_nums=[2, 2, 2, 2])
        self.mrnafnet = MRDNAFNet(width=width, middle_blk_num=middle_blk_num, enc_blk_nums=enc_blk_nums,
                                  dec_blk_nums=dec_blk_nums)
